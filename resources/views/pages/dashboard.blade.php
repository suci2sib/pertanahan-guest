...
@section('content')
    ...
    <style>
        ...
        p, li, a {
            font-weight: 500; /* Medium untuk teks biasa biar gak terlalu tipis */
        }
        ...
        .section-gray { background-color: #f9f9f9; padding: 80px 0; border-top: 1px solid #eee; }
        ...
        .section-title p { color: #777; font-size: 16px; line-height: 1.6; }
        ...
        .single-card:hover .icon-box { background-color: #ff6b81; color: #ffffff; }
        .icon-blue { background-color: #eaf6ff !important; color: #3498db !important; }
        ...
        .about-img-wrapper { position: relative; max-width: 300px; margin: 0 auto; }
        ...
        .feature-item:hover .feature-icon { background: #ff6b81; color: #fff; transform: rotate(360deg); }

        /* Flow Mini */
        .flow-wrapper { margin-top: 40px; padding-top: 30px; border-top: 1px dashed #ffe3e8; }
        .flow-icon-circle { width: 45px; height: 45px; background: #fff; border: 2px solid #fff0f3; color: #ff6b81; border-radius: 50%; display: flex; align-items: center; justify-content: center; margin: 0 auto 10px; font-size: 18px; transition: 0.3s; }
        .flow-item:hover .flow-icon-circle { background: #ff6b81; color: #fff; transform: translateY(-5px); }
        .flow-step { font-size: 11px; color: #aaa; text-transform: uppercase; letter-spacing: 1px; }

        @media (min-width: 992px) {
            .flow-arrow { position: absolute; top: 20px; right: -50%; color: #ffe3e8; font-size: 20px; }
        }

        /* --- DEVELOPER SECTION --- */
        .dev-card-hover { transition: transform 0.3s ease, box-shadow 0.3s ease; }
        .dev-card-hover:hover { transform: translateY(-5px); box-shadow: 0 15px 40px rgba(255, 107, 129, 0.15) !important; }
        ...
        .wave-container { position: absolute; top: 0; left: 0; width: 100%; overflow: hidden; line-height: 0; transform: translateY(-99%); }
        .wave-container svg { position: relative; display: block; width: calc(100% + 1.3px); height: 40px; }
        .wave-container .shape-fill { fill: #ff6b81; }
        ...
        .schedule-list li { display: flex; justify-content: space-between; margin-bottom: 8px; border-bottom: 1px dashed rgba(255,255,255,0.3); padding-bottom: 4px; }
        .copyright-area { margin-top: 25px; padding-top: 15px; border-top: 1px solid rgba(255,255,255,0.2); }
        .dev-badge { background: #fff; color: #ff6b81; padding: 4px 15px; border-radius: 20px; font-size: 12px; font-weight: 700; text-decoration: none; display: inline-block; box-shadow: 0 2px 5px rgba(0,0,0,0.1); transition: 0.3s; }
        .dev-badge:hover { background: #ffe3e8; transform: scale(1.05); }

        .whatsapp-float { position: fixed; width: 50px; height: 50px; bottom: 25px; right: 25px; background: #25d366; color: #fff; border-radius: 50%; display: flex; align-items: center; justify-content: center; z-index: 999; box-shadow: 0 4px 10px rgba(0,0,0,0.2); }
    </style>
                        ...
                        <div id="heroCarousel" class="carousel slide shadow rounded-4 overflow-hidden" data-bs-ride="carousel">
                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    <img src="{{ asset('assets/assets-guest/images/hero/tanah.jpg') }}" class="d-block w-100" alt="Peta" style="height: 400px; object-fit: cover;">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('assets/assets-guest/images/hero/tanah-2.jpg') }}" class="d-block w-100" alt="Pengukuran" style="height: 400px; object-fit: cover;">
                                </div>
                                <div class="carousel-item">
                                    <img src="{{ asset('assets/assets-guest/images/hero/tanah-3.jpg') }}" class="d-block w-100" alt="Kantor" style="height: 400px; object-fit: cover;">
                                </div>
                            </div>
    ...
    .about-label {
        background: #ffe3e8; color: #ff6b81;
        font-weight: 700; font-size: 12px; padding: 5px 15px;
    ...
    .vm-icon {
        ...
        background: #fff0f3; color: #ff6b81;
        border-radius: 50%;
        display: flex; align-items: center; justify-content: center;
        font-size: 20px; margin-bottom: 10px;
    }
    .vm-title { font-weight: 700; font-size: 16px; color: #333; margin-bottom: 5px; }
    .vm-desc { font-size: 13px; color: #666; line-height: 1.5; margin: 0; }
    ...
    .stat-number { font-size: 32px; font-weight: 800; margin-bottom: 0; }
    .stat-label { font-size: 14px; opacity: 0.9; font-weight: 500; }

    /* 4. Alur Mini (Bawah) */
    .flow-mini-title { text-align: center; font-size: 18px; font-weight: 700; color: #333; margin-bottom: 30px; }
    .flow-item { text-align: center; position: relative; }
    .flow-circle {
        width: 60px; height: 60px;
        background: #fff; border: 2px solid #fff0f3;
        color: #ff6b81; border-radius: 50%;
        display: flex; align-items: center; justify-content: center;
...
<section id="about" class="section-about-comprehensive">
            ...
            <div class="col-lg-7 wow fadeInRight">
                <div class="ps-lg-4">
                    ...
                    <p class="text-muted" style="line-height: 1.7;">
                        Platform digital yang dirancang khusus untuk memodernisasi administrasi pertanahan di tingkat desa. Kami mengubah arsip konvensional menjadi data digital yang aman dan mudah diakses.
                    </p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="vm-box">
                                ...
                                <p class="vm-desc">Mewujudkan tata kelola pertanahan desa yang transparan, akuntabel, dan bebas sengketa.</p>
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="vm-box">
                                ...
                                <p class="vm-desc">Mempermudah akses informasi kepemilikan tanah dan mempercepat pelayanan publik.</p>
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="row justify-content-center">
                ...
                <div class="col-lg-4 col-md-6 col-12 mb-4">
                    <a href="{{ route('persil.index') }}" class="text-decoration-none text-dark">
                        <div class="single-card wow fadeInUp" data-wow-delay=".2s">
                            <div class="icon-box" style="background-color: #f5eef8; color: #9b59b6;"><i class="lni lni-map"></i></div>
            ...
            <div class="row justify-content-center">
                <div class="col-lg-8 col-md-10">
                    <div class="contact-box text-center wow fadeInUp" data-wow-delay=".6s">
                        ...
                        <div class="mt-5">
                            <a href="mailto:pertanahan@binadesa.go.id" class="btn btn-primary" style="background-color: #ff6b81; border: none; padding: 12px 40px; border-radius: 30px; font-weight: 700;">Kirim Pesan</a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <div class="container">
            ...
            <div class="row justify-content-center">
                <div class="col-lg-10 col-md-12">
                    <div class="card dev-card-hover shadow-lg border-0 rounded-4 overflow-hidden wow fadeInUp" data-wow-delay=".6s">
                        <div class="row g-0">
                            <div class="col-md-5 position-relative" style="min-height: 400px;">
                                <img src="{{ asset('assets/assets-guest/images/hero/fotouci.jpg') }}" alt="Foto Pengembang" class="img-fluid w-100 h-100" style="object-fit: cover; object-position: top center;">
                            </div>
                            <div class="col-md-7 d-flex align-items-center">
                                <div class="card-body p-4 p-lg-5 text-start">
                                    <div class="d-flex justify-content-between align-items-start mb-3">
                                        <div>
                                            <h3 class="fw-bold mb-1" style="color: #333; font-size: 26px;">Suci Ramadani</h3>
                                            <p class="text-primary fw-bold mb-0" style="font-size: 15px;">Mahasiswa Sistem Informasi</p>
                                        </div>
                                        <span class="badge rounded-pill" style="background-color: rgba(255, 107, 129, 0.1); color: #ff6b81; font-weight: 700; padding: 8px 15px; border: 1px solid #ff6b81; font-size: 12px;">NIM: 2457301137</span>
                                    </div>
                                    <p class="text-muted small mb-4" style="font-weight: 600;">Fakultas Teknik, Politeknik Caltex Riau.</p>
                                    <div class="p-3 rounded-3 mb-4" style="background-color: #fff0f3; border-left: 5px solid #ff6b81;">
                                        <i class="lni lni-quotation text-muted mb-2 d-block" style="font-size: 18px;"></i>
                                        <p class="fst-italic text-dark mb-0 small" style="line-height: 1.6; font-weight: 500;">
                                            "Teknologi bukan sekadar kode dan algoritma, melainkan jembatan untuk menciptakan solusi nyata bagi masyarakat. Teruslah berkarya dan memberi dampak."
                                        </p>
                                    </div>
                                    <div class="d-flex align-items-center gap-3 mb-4">
                                        <span class="text-muted small me-2" style="font-weight: 600;">Connect:</span>
                                        <a href="https://linkedin.com/in/suci-ramadani-422b87386" target="_blank" class="text-decoration-none"><div class="d-flex align-items-center justify-content-center rounded-circle" style="width: 40px; height: 40px; background: #f0f2f5;"><i class="lni lni-linkedin-original" style="font-size: 20px; color: #0077b5;"></i></div></a>
                                        <a href="https://github.com/suci2sib" target="_blank" class="text-decoration-none"><div class="d-flex align-items-center justify-content-center rounded-circle" style="width: 40px; height: 40px; background: #f0f2f5;"><i class="lni lni-github-original" style="font-size: 20px; color: #333;"></i></div></a>
                                        <a href="https://instagram.com/sucyy_rhmdni" target="_blank" class="text-decoration-none"><div class="d-flex align-items-center justify-content-center rounded-circle" style="width: 40px; height: 40px; background: #f0f2f5;"><i class="lni lni-instagram-original" style="font-size: 20px; color: #E1306C;"></i></div></a>
                                    </div>
                                    <div>
                                        <a href="https://wa.me/628123456789" class="btn btn-primary shadow-sm" style="background-color: #ff6b81; border: none; padding: 10px 30px; border-radius: 50px; font-weight: 700; letter-spacing: 0.5px;">
    ...
    <a href="https://wa.me/6281234567890" target="_blank" class="whatsapp-float">
        <img src="https://upload.wikimedia.org/wikipedia/commons/6/6b/WhatsApp.svg" alt="WA" class="whatsapp-icon" style="width: 28px;">
    </a>
