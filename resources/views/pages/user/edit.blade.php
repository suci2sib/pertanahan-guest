...
<section id="form-user" class="section contact-area">
    <div class="container">
        <div class="section-title text-center">
            <h3 class="wow zoomIn" data-wow-delay=".2s">Edit Data User</h3>
            <h2 class="wow fadeInUp" data-wow-delay=".4s">Perbarui Informasi Pengguna</h2>
            <p class="wow fadeInUp" data-wow-delay=".6s">
                Silakan ubah data user sesuai kebutuhan dan simpan perubahan.
            </p>
        </div>
                        ...
                        <form action="{{ route('user.update', $dataUser->id) }}" method="POST">
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6 mb-3">
                                    ...
                                    <input type="password" name="password" id="password" value="{{ old('password', $dataUser->password) }}"
